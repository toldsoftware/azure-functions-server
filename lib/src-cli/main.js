...
function createDeployment() {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        var _this = this;
        var isProduction_1, isClient_1, shouldInject_1, functionDirsOrFiles_1, entrySourceFiles_1, pending_1, ready_1, afsLibPath_1, targetAfsLibPath_1, serverDir_1, clientDir_1;
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    try {
                        ...
                        shouldInject_1 = process.argv.some(function (x) { return x.match(/--debug/) != null; });
                                ...
                                return tslib_1.__generator(this, function (_a) {
                                    switch (_a.label) {
                                        ...
                                        case 1:
                                            ...
                                            // Wabpack
                                            console.log('Webpack');
                                            return [4 /*yield*/, run_webpack_1.runWebpackClient(entrySourceFiles_1, shouldInject_1)];
                                        case 2:
                                            _a.sent();
                                            if (!isProduction_1) return [3 /*break*/, 4];
                                            return [4 /*yield*/, run_webpack_1.runWebpackAzureFunction(functionDirsOrFiles_1, shouldInject_1)];
                                        case 3:
                                            _a.sent();
                                            _a.label = 4;
                                        case 4:
